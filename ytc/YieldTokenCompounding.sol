...
contract YieldTokenCompounding {
    ...
    address balVaultAddress = 0xBA12222222228d8Ba445958a75a0704d566BF2C8;

    constructor() {
        balVault = IVault(balVaultAddress);
    }
    ...
    function compound(
        ...
        // Step 1: Assume the user approves the contract for the base token 
        //[permit support is a nice to have in general but for simplicity fine to omit]

        // Step 2: User calls deposit, the smart contract uses transferFrom to move the tokens 
        //from the user to the WP for the tranche.
