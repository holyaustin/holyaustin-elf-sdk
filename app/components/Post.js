...
export default function Post({  creatorAddress,  ownerAddress,  createdAtTimestamp,
                                mimeType,  contentURI,  name,  ...props
                            }) {
  const comparePrices = () => {
    // <Link href={'/api/prices/'}>
    //   {/* <a>
    ...
    // </Link>
    <Link href={`/create`}>
      <a className={styles.header__menu_button_black}>Property prices</a>
    </Link>
  }
  ...
  return (
    <div className={styles.showcase__card} {...props}>
      ...
      <div>
          ...
          <Link href={`/prices`}>
              <a className={styles.header__menu_button_blue}>Similar Property</a>
          </Link>
